...
class Authlms 
{
    ...
    public function auth_lms_first(){
        ...
        $client = new nusoap_client('http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/belcorpws_server.php?wsdl', 'WSDL');
        ...
        $url='http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/client/client.php?usuario='.$username.'&token='.$answer.'&curso='.$id_curse;
        //output the response (in the form of a multidimensional array) from the function call:
        return '{exp:redirecturl url="'.$url.'"}';
        //header('Location: http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/client/client.php?usuario=peppinedo&token=ABCD&curso=24' );
        /*
    ...
    public function auth_lms_access_profile(){
        ...
        $url='http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/client/clientprofile.php?usuario='.$username.'&token='.$answer;
        //$url='http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/client/clientprofile.php?usuario=peppinedo&token='.$answer;
        //output the response (in the form of a multidimensional array) from the function call:
        return '{exp:redirecturl url="'.$url.'"}';
        //header('Location: http://ucb.caleidosmedia.com/moodlecolaboradores/auth/belcorpws/client/client.php?usuario=peppinedo&token=ABCD&curso=24' );
        /*
